    ...
    public class DcTests
    {
        public class TestSource
        {
            ...
            public Source ToSource(DirectoryInfo sourceDir)
            {
                ...
                {
                    FileInfo documentDocx = new(Path.Combine(sourceDir.FullName, DocumentFile));
                    result = new Source(documentDocx.FullName);
                }
                else
                {
                    FileInfo templateDocx = new(Path.Combine(sourceDir.FullName, TemplateFile));
                    FileInfo dataFile = new(Path.Combine(sourceDir.FullName, DataFile));
